...
<body class=" text-black">
  ...
  <section class="relative w-[100%] min-h-screen flex justify-center items-start">
    <header class="absolute top-0 left-0 w-[100%] z-10">
      <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-black text-white">
    ...
    <video src="nightlife.mp4" autoplay muted loop class="fixed left-0 top-0 w-[100%] h-[100%] object-cover blur-[2px]"></video>

    <div class="flex flex-col mt-20">
      <div class="flex justify-end mr-6 mt-4 z-10">
    ...
    VALUES (?,?,?,?,?,?,?)";
      ...
      if ($data) {
        ...
        while ($row = $data->fetch_assoc()) {
          echo '<div class="max-w-sm bg-gray-800 rounded-lg shadow-lg p-6 m-6 z-10">
      ...
      <footer class="relative bottom-0 left-0 w-[100%] bg-black z-20">
